Rails.application.routes.draw do
  ...
  get '/tadpoles/:id/metamorphosize', to: 'tadpoles#metamorphose'
  post '/tadpoles/:id/metamorphosize', to: 'tadpoles#metamorphose'
  patch '/tadpoles/:id/metamorphosize', to: 'tadpoles#metamorphose'
